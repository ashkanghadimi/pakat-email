...
if ( ! class_exists( 'SIB_Page_Scenarios' ) ) {
	...
	class SIB_Page_Scenarios {
		...
		function generate_main_page() {
			$ma_link = 'https://automation.pakat.net/scenarios/?create_new_scenario';
			$ma_exist_link = 'https://automation.pakat.net/scenarios/?utm_source=wordpress_plugin&utm_medium=plugin&utm_campaign=module_link';
			$ma_logs_link = 'https://automation.pakat.net/log/scenarios/?utm_source=wordpress_plugin&utm_medium=plugin&utm_campaign=module_link';
