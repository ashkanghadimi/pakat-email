			...
			<div id="main-content" class="sib-content">
				...
				<div class="page-header"><strong><?php esc_attr_e( 'Forms', 'sib_lang' ); ?></strong></div>
					...
					<form method="post" class="sib-forms-wrapper" style="padding:20px;min-height: 500px;">
						<i style="font-size: 13px;"><?php esc_attr_e( "Note: Forms created in Pakat plugin for WordPress won't be displayed in Forms section in Pakat application", 'sib_lang' ); ?></i>
			<?php
			$this->forms->display();
			?>
					</form>
								...
								<div class="row <!--small-content-->">
									...
									<div class="col-md-6">
										...
										<input type="hidden" id="sib_hidden_message_1"
											   value="<?php esc_attr_e( 'Select Pakat Attribute', 'sib_lang' ); ?>">
										<input type="hidden" id="sib_hidden_message_2"
											   value="<?php esc_attr_e( 'Pakat merge fields : Normal', 'sib_lang' ); ?>">
										<input type="hidden" id="sib_hidden_message_3"
											   value="<?php esc_attr_e( 'Pakat merge fields : Category', 'sib_lang' ); ?>">
							...
							<div id="sib_setting_signup_body" class="panel-body">
								<div id="sib_form_alert_message" class="alert alert-danger alert-dismissable fade in"
									...
									<span id="sib_disclaim_smtp"
										  style="display: none;"><?php _e( 'Confirmation emails will be sent through your own email server, but you have no guarantees on their deliverability. <br/> <a href="https://smtp.pakat.net" target="_blank">Click here</a> to send your emails through Pakat in order to improve your deliverability and get statistics', 'sib_lang' ); ?></span>
								...
								<div class="row" id="sib_confirm_template_area">
									...
									<div class="col-md-4">
										<a href="https://email.pakat.net/camp/listing#temp_active_m" class="col-md-12"
										   target="_blank"><i
								...
								<div class="row" id="sib_doubleoptin_template_area">
									...
									<div class="col-md-4">
										<a href="https://email.pakat.net/camp/listing?utm_source=wordpress_plugin&utm_medium=plugin&utm_campaign=module_link#temp_active_m"
