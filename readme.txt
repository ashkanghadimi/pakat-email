=== Pakat Subscribe Form And WP SMTP ===
Contributors: neeraj_slit, hadifarnoud, behzadsh
Tags: Pakat, marketing automation, email marketing, email campaign, newsletter, wordpress smtp, subscription form, phpmailer, SMTP, wp_mail, massive email, sendmail, ssl, tls, wp-phpmailer, mail smtp, mailchimp, newsletters, email plugin, signup form, email widget, widget, plugin, sidebar, shortcode
...
<a href="https://www.pakat.net/?utm_source=wordpress_plugin&utm_medium=plugin&utm_campaign=profile_page" target="_blank">Pakat</a>’s official plugin for WordPress is a powerful all-in-one email marketing plugin. At a glance:
<ul>
...
<li><b>Transactional emails</b> - The wp_mail() function automatically uses Pakat’s SMTP for enhanced deliverability and tracking</li>
...
<li><b>Marketing automation</b> - Enable Automation on WordPress to auto-install the script on your website and the identify tag on the Pakat forms and Wordpress Login </li>
</ul> 
...
<li>Auto-deployment of the identify tag for Pakat’s forms and Wordpress plugin</li>
<li>Access to the Pakat online dashboard for workflow creation and management</li>
</ul>  

= Plugin Support =
To get support, please send an email to <a href="mailto:support@pakat.net">support@pakat.net</a>, we will be happy to help you!

The plugin is available in English and French. 

== Installation ==

1.	In your WordPress admin panel, go to Plugins > New Plugin, search for "Pakat for WP" and click "Install now". Alternatively, download the plugin and upload the contents of pakat-email.zip to your plugins directory, which may be  /wp-content/plugins/. 
2.	Activate the Pakat plugin through the 'Plugins' menu in WordPress. 
3.	The "Pakat" tab must appear in your WordPress side navigation panel, then set your <a href="https://profile.pakat.net/profile" target="_blank">Pakat API key</a> in the plugin homepage.

To get a Pakat API key, you have to <a href="https://profile.pakat.net/signin/?utm_source=wordpress_plugin&utm_medium=plugin&utm_campaign=profile_page" target="_blank">create an account</a>. It's free and takes less than 2 minutes!

== Screenshots ==
1. First, your are invited to create an account on Pakat then enter your API keys
2. The Homepage gives you an overall view over your campaigns and allows you to activate Pakat SMTP for all transactional emails and Marketing Automation to better target your customers
...
8. From the Widget page, you are able to add the Pakat widget in one or more sidebars. For each form, you can choose the fields displayed and the list where contacts are saved.
9. The Workflows page (Marketing Automation activated) allows you to create new workflows in Pakat or access your logs or existing workflows

== Frequently Asked Questions ==

= What is Pakat? =
Pakat is a powerful all-in-one marketing platform. Over 15,000 companies around the world trust Pakat to deliver their emails and SMS messages. Combining many powerful features, competitive pricing  and excellent deliverability thanks to our proprietary cloud-based infrastructure, Pakat is available and supported in 6 languages: English, French, Spanish, German, Italian, and Portuguese.

= Why use Pakat as an SMTP relay for my website? =
By using Pakat’s SMTP, you will avoid the risk of having your legitimate emails ending up in the spam folder and you will have statistics on emails sent: deliverability, opens, clicks, etc. Pakat’s proprietary infrastructure optimizes your deliverability, enabling you to focus on your content.

= Why do I need a Pakat account? =
The Pakat for WordPress plugin uses Pakat’s API to synchronize contacts, send emails and get statistics. Creating an account on Pakat is free and takes less than 2 minutes. Once logged into your account, you can get the API key.
 
= Do I have to pay to use the plugin and send emails? =
No, the plugin is totally free and Pakat offers a free plan with 9,000 emails per month. If you need to send more than 9,000 emails / month, we invite you to see our pricing. All Pakat plans are without any commitment.

= How do I get my get synchronize my lists? =
You have nothing to do - synchronization is automatic! It doesn't matter whether your lists were uploaded on your WordPress interface or on your Pakat account: they will always remain up-to-date on both sides.

= How can I get support? =
If you need some assistance, you can post an issue in the Support tab, or send us an email at support@pakat.net.

= How do I create a signup form? =
In order to create a signup form, you need to:
1. Go to Wp admin > Pakat > Settings in order to define your form’s fields and settings
2. Integrate the form in a sidebar using a widget from WP panel > Appearance > Widgets. The Pakat widget form should appear in your widgets list, you just to have to drag and drop the widget into the sidebar of your choice. 
...
* fix Pakat account info display issue.
...
= 2.7.3 =
* add independence between Pakat plugins
...
= 2.6.13 =
* Fix Pakat dev url to prod url in list page
...
= 2.4.4 =
* Update Pakat API library into V2.0
...
= 2.3.10 =
* Add the functionality to integrate the category attributes of Pakat.
